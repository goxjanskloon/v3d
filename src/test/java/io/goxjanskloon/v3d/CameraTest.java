...
public class CameraTest{
    @Test public void render()throws IOException{
        ...
        world.add(new Sphere(new Vector(-5.0,0.0,0.0),5.0,new Material(0.5,2.0,new SolidTexture(Color.WHITE))));
        ...
        Camera camera=new Camera(bvhTree,ray,-Math.PI/2,600,360,8,5000,Color.BLACK,12);
