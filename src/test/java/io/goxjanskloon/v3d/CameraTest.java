...
public class CameraTest{
    @Test public void render()throws IOException{
        ...
        Sphere sphere1=new Sphere(new Vector(-5.0,0.0,0.0),5.0,Color.RED,1.0,1.0);
        Sphere sphere2=new Sphere(new Vector(5.0,0.0,0.0),5.0,Color.BLUE,0.1,0.0);
        world.add(sphere1);
        world.add(sphere2);
        BvhTree bvhTree=new BvhTree(world);
        Ray ray=new Ray(new Vector(0.0,0.0,-20.0),new Vector(0.0,0.0,300.0));
        Camera camera=new Camera(bvhTree,ray,-Math.PI/2,600,360,8,100,Color.WHITE.scale(0.0));
